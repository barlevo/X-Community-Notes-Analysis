...
This module analyzes the 15-topic classification results from the full dataset
and creates comprehensive graphs and statistics for presentation.
...
class ClassificationAnalyzer:
    ...
    for the topic classification results, including distribution analysis,
    confidence metrics, temporal trends, and geopolitical focus analysis.
    ...
    Attributes:
        ...
        summary_data: Dictionary containing summary metadata
    """
    
    def __init__(self, results_dir: str | Path = "custom_topic_results", 
                 output_dir: str | Path = "classification_analytics"):
        """
        Initialize the ClassificationAnalyzer.
        
        Args:
            results_dir: Path to directory containing classification results
            output_dir: Path to directory for saving analysis outputs
        """
        self.results_dir = Path(results_dir)
        self.classified_notes: Optional[pd.DataFrame] = None
    ...
    def load_latest_results(self) -> Tuple[pd.DataFrame, Optional[Dict[str, Any]]]:
        """
        Load the most recent classification results from the results directory.
        
        Returns:
            Tuple of (classified_notes_df, summary_data_dict)
    ...
    def create_topic_distribution_chart(self) -> pd.Series:
        """
        Create comprehensive topic distribution charts (bar and pie charts).
    ...
    def create_confidence_analysis(self) -> Tuple[pd.Series, pd.DataFrame]:
        """
        Analyze and visualize model confidence scores.
        
        Creates multiple visualizations:
        - Overall confidence distribution histogram
        - Confidence by topic (box plot)
        - Low confidence notes analysis
        - Topic size vs confidence correlation
    ...
    def create_geopolitical_focus_chart(self) -> Tuple[pd.Series, pd.Series]:
        """
        Create specific analysis for geopolitical/conflict topics.
        
        Separates topics into geopolitical/conflict vs general categories
    ...
    def create_time_series_analysis(self) -> Optional[pd.DataFrame]:
        """
        Analyze topics over time if timestamp data is available.
        
        Creates temporal trend visualizations with key event markers.
        Filters data to June 2023 onwards for relevance.
    ...
    def create_summary_statistics(self) -> Dict[str, Any]:
        ...
        - Dataset overview (total notes, unique topics)
        - Topic distribution metrics
        - Confidence statistics
        - Geopolitical vs general content breakdown
    ...
    def run_complete_analysis(self) -> Dict[str, Any]:
        ...
        1. Load latest classification results
        2. Create topic distribution charts
        3. Perform confidence analysis
        4. Analyze geopolitical focus
